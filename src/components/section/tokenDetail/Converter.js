...
function Converter() {
  return (
    <div className="min-w-[400px]">
      ...
      <div className="mt-4 bg-[#F1F3F5] dark:bg-[#121318] rounded-2xl flex justify-between items-center p-6 border border-[#DFDFDF] dark:border-[#23262F]">
        <div className="flex justify-start items-center gap-3">
          <img src="/img/tokens/token1.png" alt="" className="w-12 h-12" />
          <div className="text-sm">
            <p className="dark:text-[#9B9B9B]">BTC</p>
            <p className="text-lg dark:text-white">Bitcoin</p>
          </div>
        </div>
      ...
      <div className="bg-[#F1F3F5] dark:bg-[#121318] rounded-2xl flex justify-between items-center p-6 border border-[#DFDFDF] dark:border-[#23262F]">
        <div className="flex justify-start items-center gap-3">
          <img src="/img/tokens/token2.png" alt="" className="w-12 h-12" />
          <div className="text-sm">
            <p className="dark:text-[#9B9B9B]">USD</p>
            <p className="text-lg dark:text-white">United States Dollar</p>
          </div>
        </div>
